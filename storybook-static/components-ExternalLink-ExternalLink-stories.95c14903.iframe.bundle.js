/*! For license information please see components-ExternalLink-ExternalLink-stories.95c14903.iframe.bundle.js.LICENSE.txt */
;(self.webpackChunk = self.webpackChunk || []).push([
  [207],
  {
    './src/components/ExternalLink/ExternalLink.stories.tsx': (
      ...
      var jsx_runtime = __webpack_require__(
        ...
        ExternalLink_module = __webpack_require__(
          './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].use[1]!./node_modules/postcss-loader/dist/cjs.js!./src/components/ExternalLink/ExternalLink.module.css',
        ),
        options = {}
      ...
      injectStylesIntoStyleTag_default()(ExternalLink_module.A, options)
      const ExternalLink_ExternalLink_module =
        ExternalLink_module.A && ExternalLink_module.A.locals
          ? ExternalLink_module.A.locals
          : void 0
      function ExternalLink(param) {
        let { text = '', className, style, url } = param
        const externalLinkClass = classnames_default()(
          ExternalLink_ExternalLink_module.externalLink,
          className,
          [ExternalLink_ExternalLink_module[style]],
        )
        return (0, jsx_runtime.jsx)('div', {
          className: externalLinkClass,
          children: (0, jsx_runtime.jsx)('a', {
            href: url,
            className: ExternalLink_ExternalLink_module.externalLink,
            children: text,
          }),
        })
      }
      ...
      ExternalLink.__docgenInfo = {
        ...
        props: {
          ...
          url: { required: !1, tsType: { name: 'string' }, description: '' },
        },
      }
      const ExternalLink_stories = {
          title: 'Components/ExternalLink',
          component: ExternalLink,
          parameters: { layout: 'centered' },
          tags: ['autodocs'],
        },
        Default = { args: { text: 'Default', style: 'default' } },
        Primary = { args: { style: 'primary', text: 'Primary' } },
        Secondary = { args: { style: 'secondary', text: 'Secondary' } },
        Disabled = { args: { style: 'disabled', text: 'Disabled' } }
      ;(Default.parameters = {
        ...Default.parameters,
        docs: {
    ...
    './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].use[1]!./node_modules/postcss-loader/dist/cjs.js!./src/components/ExternalLink/ExternalLink.module.css':
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          '/* Default Link */\n.ExternalLink_externalLink__ipz5q {\n  color: #007bff;\n  text-decoration: none;\n  transition: color 0.3s ease;\n}\n\n.ExternalLink_externalLink__ipz5q:hover {\n  color: #0056b3;\n  text-decoration: underline;\n}\n\n/* Primary Link */\n.ExternalLink_externalLink__ipz5q.ExternalLink_primary__oDiJm {\n  color: #28a745;\n}\n\n.ExternalLink_externalLink__ipz5q.ExternalLink_primary__oDiJm:hover {\n  color: #218838;\n}\n\n/* Secondary Link */\n.ExternalLink_externalLink__ipz5q.ExternalLink_secondary__cfMos {\n  color: #6c757d;\n}\n\n.ExternalLink_externalLink__ipz5q.ExternalLink_secondary__cfMos:hover {\n  color: #545b62;\n}\n\n/* Disabled Link */\n.ExternalLink_externalLink__ipz5q.ExternalLink_disabled__7c24d,\n.ExternalLink_externalLink__ipz5q:disabled {\n  color: #6c757d;\n  pointer-events: none;\n  cursor: not-allowed;\n  text-decoration: none;\n}\n',
          '',
          {
            version: 3,
            sources: [
              'webpack://./src/components/ExternalLink/ExternalLink.module.css',
            ],
            names: [],
            mappings:
              'AAAA,iBAAiB;AACjB;EACE,cAAc;EACd,qBAAqB;EACrB,2BAA2B;AAC7B;;AAEA;EACE,cAAc;EACd,0BAA0B;AAC5B;;AAEA,iBAAiB;AACjB;EACE,cAAc;AAChB;;AAEA;EACE,cAAc;AAChB;;AAEA,mBAAmB;AACnB;EACE,cAAc;AAChB;;AAEA;EACE,cAAc;AAChB;;AAEA,kBAAkB;AAClB;;EAEE,cAAc;EACd,oBAAoB;EACpB,mBAAmB;EACnB,qBAAqB;AACvB',
            sourcesContent: [
              '/* Default Link */\n.externalLink {\n  color: #007bff;\n  text-decoration: none;\n  transition: color 0.3s ease;\n}\n\n.externalLink:hover {\n  color: #0056b3;\n  text-decoration: underline;\n}\n\n/* Primary Link */\n.externalLink.primary {\n  color: #28a745;\n}\n\n.externalLink.primary:hover {\n  color: #218838;\n}\n\n/* Secondary Link */\n.externalLink.secondary {\n  color: #6c757d;\n}\n\n.externalLink.secondary:hover {\n  color: #545b62;\n}\n\n/* Disabled Link */\n.externalLink.disabled,\n.externalLink:disabled {\n  color: #6c757d;\n  pointer-events: none;\n  cursor: not-allowed;\n  text-decoration: none;\n}\n',
            ],
            sourceRoot: '',
          },
        ]),
          (___CSS_LOADER_EXPORT___.locals = {
            externalLink: 'ExternalLink_externalLink__ipz5q',
            primary: 'ExternalLink_primary__oDiJm',
            secondary: 'ExternalLink_secondary__cfMos',
            disabled: 'ExternalLink_disabled__7c24d',
          })
