    ...
    './src lazy recursive ^\\.\\/.*$ include: (?%21.*node_modules)(?:\\/src(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)(?%21\\.)(?=.)[^/]*?\\.stories\\.(js%7Cjsx%7Cmjs%7Cts%7Ctsx))$':
      (module, __unused_webpack_exports, __webpack_require__) => {
        var map = {
          ...
          './components/ExternalLink/ExternalLink.stories': [
            './src/components/ExternalLink/ExternalLink.stories.tsx',
            207,
          ],
          './components/ExternalLink/ExternalLink.stories.tsx': [
            './src/components/ExternalLink/ExternalLink.stories.tsx',
            207,
          ],
          './components/IconButton/IconButton.stories': [
          ...
          './components/Layouts/Header/Header.stories': [
            './src/components/Layouts/Header/Header.stories.tsx',
            333,
          ],
          './components/Layouts/Header/Header.stories.tsx': [
            './src/components/Layouts/Header/Header.stories.tsx',
            333,
          ],
          './components/SearchInput/SearchInput.stories': [
            './src/components/SearchInput/SearchInput.stories.tsx',
            957,
            543,
          ],
          './components/SearchInput/SearchInput.stories.tsx': [
            './src/components/SearchInput/SearchInput.stories.tsx',
            957,
            543,
          ],
          ...
          './stories/Page.stories': ['./src/stories/Page.stories.ts', 852, 290],
